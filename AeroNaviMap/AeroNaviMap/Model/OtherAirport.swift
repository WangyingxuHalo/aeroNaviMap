...
class OtherAirport: Airport {

    init(title: String?, subtitle: String?, airport_id: Int?, lonx: Double?, laty: Double?) {
        super.init(title: title, subtitle: subtitle, airport_id: airport_id, lonx: lonx, laty: laty, imageName: "otherAirport")
    }
